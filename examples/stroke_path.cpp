...
ShapeList strikeOut(const Path & path, double strokeWidth, Shape::LineCap lineCap, Shape::LineJoin lineJoin, double miterLimit = 4.0)
{
  const double s = 1.0;
  ShapeList list;
...
int main(int, char * [])
{
  ...
  ShapeList l;
  l.append(strikeOut(pA, 50.0, Shape::RoundCap, Shape::MiterJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pB, 50.0, Shape::RoundCap, Shape::BevelJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pC, 50.0, Shape::RoundCap, Shape::MiterJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pA, 50.0, Shape::RoundCap, Shape::RoundJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  ...
  l.clear();
  l.append(strikeOut(pA, 50.0, Shape::ButtCap, Shape::MiterJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pB, 50.0, Shape::ButtCap, Shape::BevelJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pC, 50.0, Shape::ButtCap, Shape::MiterJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pA, 50.0, Shape::ButtCap, Shape::RoundJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(Text(0, 0, "Butt cap, miter/bevel/miter/round join", Fonts::Courier, 14.0), ShapeList::Right, ShapeList::AlignCenter);
  board.append(l, ShapeList::Bottom, ShapeList::AlignLeft);

  l.clear();
  l.append(strikeOut(pA, 50.0, Shape::SquareCap, Shape::MiterJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pB, 50.0, Shape::SquareCap, Shape::BevelJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pC, 50.0, Shape::SquareCap, Shape::MiterJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
  l.append(strikeOut(pA, 50.0, Shape::SquareCap, Shape::RoundJoin, 3.0), ShapeList::Right, ShapeList::AlignCenter, 30.0);
