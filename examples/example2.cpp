...
int main( int, char *[] )
{
  ...
  board.setLineWidth( 8 )
    .setPenColor( Color::Black )
    .setFillColorRGBi( 0, 0, 255, 50 ).drawRectangle( -1, 0, 1, 0.5 );

  board.setLineJoin( Shape::MiterJoin );
  board.setLineWidth( 2 )
    .setPenColor( Color::Red )
    .drawTriangle( -0.5, -0.25, 0, 0.25, 0.5, -0.25 );
  board.setLineWidth( 1.5 )
    .setPenColorRGBi( 255, 100, 0 )
    .drawLine( -0.5, -0.27, 0.5, -0.27 );
  
  board.setPenColor( Color::Black )
    .setFont( Fonts::HelveticaBold, 12.0 )
    .drawText( 0, 0.5, "Hello world!" );
