...
bool
isASharpCorner(Point p1, Point p2, Point p3) {
  return (p3-p2) * (p2-p1) < 0.0;
}

double
sharpCornerAngle(Point p1, Point p2, Point p3) {
...
Point
intersection(EuclideanLine l1, EuclideanLine l2)
{
...
void
exteriorBevelIntersection(Point p1, Point p2, Point p3,
                          double strokeWidth,
                          Point & a, Point & b)
{
  Point va(p2-p1);
...
std::vector<Point>
exteriorRoundIntersection(Point p1, Point p2, Point p3,
                          double strokeWidth )
{
  ...
  angleFirst -= M_PI_2;
  angleSecond -= M_PI_2;
  if ( angleFirst < -M_PI) angleFirst += 2 * M_PI;
...
void
butCapExtremities(Point p1, Point p2,
                  double strokeWidth,
                  Point & a, Point & b)
{
  Point v(p2-p1);
...
void
squareCapExtremities(Point p1, Point p2,
                     double strokeWidth,
                     Point & a, Point & b)
{
  Point v(p2-p1);
...
std::vector<Point>
roundCapExtremities(Point p1, Point p2, double strokeWidth)
{
  std::vector<Point> result;
...
std::vector<Point>
pathBoundaryPoints(const Path & path,
                   double strokeWidth,
